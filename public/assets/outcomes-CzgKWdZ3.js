(function(){let e=document.createElement(`link`).relList;if(e&&e.supports&&e.supports(`modulepreload`))return;for(let e of document.querySelectorAll(`link[rel="modulepreload"]`))n(e);new MutationObserver(e=>{for(let t of e)if(t.type===`childList`)for(let e of t.addedNodes)e.tagName===`LINK`&&e.rel===`modulepreload`&&n(e)}).observe(document,{childList:!0,subtree:!0});function t(e){let t={};return e.integrity&&(t.integrity=e.integrity),e.referrerPolicy&&(t.referrerPolicy=e.referrerPolicy),e.crossOrigin===`use-credentials`?t.credentials=`include`:e.crossOrigin===`anonymous`?t.credentials=`omit`:t.credentials=`same-origin`,t}function n(e){if(e.ep)return;e.ep=!0;let n=t(e);fetch(e.href,n)}})();var e=class{constructor(e){this.parent=e}getHTML(e){return`
        ...
        `}clickBack(){this.onGoBack()}render(){this.parent.innerHTML=``,new t(this.parent).render(this.clickBack.bind(this)),this.parent.insertAdjacentHTML(`beforeend`,`<div id="product-page_outcomes" class="st_calc-calculator-wrapper"></div>`),this.getData()}},u=class{constructor(e,t,n,r,i){this.parent=e,this.data=t,this.onAdd=n,this.onDelete=r,this.onGoBack=i}async getData(){let e=await r.get(i.getStocks());this.renderData(e)}renderData(t){this.cardsGrid.innerHTML=``,c(t).forEach(t=>{new e(this.cardsGrid).render(t,this.clickCard.bind(this),this.onDelete)})}get pageRoot(){return document.getElementById(`main-page_outcomes`)}get cardsGrid(){return document.getElementById(`cards-container_outcomes`)}getHTML(){return`
        ...
        `}clickCard(e){let t=e.target.dataset.id;new l(this.parent,t,this.data,this.onGoBack).render()}render(){this.parent.innerHTML=``,new t(this.parent).render(()=>window.location.reload());let e=this.getHTML();this.parent.insertAdjacentHTML(`beforeend`,e),document.getElementById(`add-card-btn_outcomes`).addEventListener(`click`,this.onAdd),this.getData(),document.getElementById(`filter-btn_outcomes`).addEventListener(`click`,async()=>{let e=document.getElementById(`filter-input_outcomes`).value.trim();if(e===``)return;let t=await r.get(i.getStocks()+`?title=`+encodeURIComponent(e));this.renderData(t)}),document.getElementById(`reset-filter-btn_outcomes`).addEventListener(`click`,()=>{document.getElementById(`filter-input_outcomes`).value=``,this.getData()})}},d=document.getElementById(`root`);function f(e){new u(d,e,m,h,f).render()}async function p(){f(await r.get(i.getStocks()))}async function m(){let e={title:`Выборка №${Date.now()}`,description:`Новая статистическая выборка`,values:[]};await r.post(i.createStock(),e),p()}async function h(e){await r.delete(i.removeStockById(e)),p()}p();